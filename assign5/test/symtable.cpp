...
//     cout << "In-order traversal of AVL tree before removal: ";
...
//     string c = "D";
//     table->remove(c);
//     cout << "In-order traversal of AVL tree after removing key "<< c << ": ";
//     inOrderTraversal(table->get_root());
//     cout << endl;

//     string b = "J";
//     table->remove(b);
//     cout << "In-order traversal of AVL tree after removing key "<< b << ": ";
//     inOrderTraversal(table->get_root());
//     cout << endl;

//     string a = "I";
//     table->remove(a);
//     cout << "In-order traversal of AVL tree after removing key "<< a << ": ";
//     inOrderTraversal(table->get_root());
//     cout << endl;
    
//     string d = "G";
//     table->remove(d);
//     cout << "In-order traversal of AVL tree after removing key "<< d << ": ";
//     inOrderTraversal(table->get_root());
//     cout << endl;

//     table->assign_address("A",32);

//     cout<< table->search("A") << endl;
//     cout<< table->search("B") << endl;

//     string e = "B";
//     table->remove(e);
//     cout << "In-order traversal of AVL tree after removing key "<< e << ": ";
//     inOrderTraversal(table->get_root());
//     cout << endl;

//     string f = "A";
//     table->remove(f);
//     cout << "In-order traversal of AVL tree after removing key "<< f << ": ";
//     inOrderTraversal(table->get_root());
//     cout << endl;
    
//     string g = "F";
//     table->remove(g);
//     cout << "In-order traversal of AVL tree after removing key "<< g << ": ";
//     inOrderTraversal(table->get_root());
//     cout << endl;

//     string h = "H";
//     table->remove(h);
//     cout << "In-order traversal of AVL tree after removing key "<< h << ": ";
//     inOrderTraversal(table->get_root());
//     cout << endl;

//     string z = "E";
//     table->remove(z);
//     cout << "In-order traversal of AVL tree after removing key "<< z << ": ";
//     inOrderTraversal(table->get_root());
//     cout << endl;
